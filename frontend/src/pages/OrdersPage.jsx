...
const OrdersPage = () => {
   ...
   const userId = "user-123"; // Static user for now
   ...
   return (
      <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8">
               ...
               <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  {activeOrders.map((order) => (
                     <LiveOrderTracker key={order.id} order={order} />
                  ))}
               </div>
            </div>
         )}
         ...
         <div className="space-y-4">
            {(activeOrders.length > 0 ? completedOrders : safeOrders).map((order) => (
         ...
         <div className="mt-8 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
               <div className="bg-white p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-blue-600">{safeOrders.length}</p>
               </div>
               <div className="bg-white p-4 rounded-lg">
